"""
mapper_tsne_pharmacokinetic_physicochemical_sweep.py
======================================================
Parameter optimization sweep for the t-SNE pharmacokinetic/physicochemical
mapper (Figure 7): random search for 2 hours, then an exhaustive zoom
around the top 5 winners for 45 minutes. This is the search that produced
the parameters used in mapper_tsne_pharmacokinetic_physicochemical.py.
"""
...
LIVE_LOG_CSV = os.path.join(LOGS_DIR, "tsne_basic_live_log.csv")
PHASE1_CSV = os.path.join(LOGS_DIR, "tsne_basic_phase1_leaderboard.csv")
PHASE2_CSV = os.path.join(LOGS_DIR, "tsne_basic_phase2_leaderboard.csv")
