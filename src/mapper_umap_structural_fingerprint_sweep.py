"""
mapper_umap_structural_fingerprint_sweep.py
=============================================
Parameter optimization sweep for the UMAP structural fingerprint mapper
(Figure 10): random search for 2 hours, then an exhaustive zoom around
the top 5 winners for 45 minutes, run on the decoded 881-bit fingerprint
...
LIVE_LOG_CSV = os.path.join(LOGS_DIR, "umap_fp_live_log.csv")
PHASE1_CSV = os.path.join(LOGS_DIR, "umap_fp_phase1_leaderboard.csv")
PHASE2_CSV = os.path.join(LOGS_DIR, "umap_fp_phase2_leaderboard.csv")
...
UMAP_SPACE = {
    ...
    "metric": ["cosine", "jaccard", "euclidean", "manhattan"],
    "spread": [0.5, 1.0, 2.0],
