"""
mapper_umap_combined_sweep.py
===============================
Parameter optimization sweep for the UMAP combined mapper (Table 1 "Umap
combined"; Figure 12): random search for 2 hours, then an exhaustive
zoom around the top 5 winners for 45 minutes, run on the combined
(pharmacokinetic + physicochemical + structural) feature matrix. This is
the search that produced the parameters used in
mapper_combined.py:build_umap_combined_mapper() — also the basis for the
...
LIVE_LOG_CSV = os.path.join(LOGS_DIR, "umap_combined_live_log.csv")
PHASE1_CSV = os.path.join(LOGS_DIR, "umap_combined_phase1_leaderboard.csv")
PHASE2_CSV = os.path.join(LOGS_DIR, "umap_combined_phase2_leaderboard.csv")
